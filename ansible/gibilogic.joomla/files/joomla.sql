...
--
-- Host: localhost
-- Generation Time: Aug 27, 2016 at 12:48 PM
...
--
-- Table structure for table `yegods_assets`
--

CREATE TABLE `yegods_assets` (
...
--
-- Dumping data for table `yegods_assets`
--

INSERT INTO `yegods_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `yegods_associations`
--

CREATE TABLE `yegods_associations` (
...
--
-- Table structure for table `yegods_banners`
--

CREATE TABLE `yegods_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `yegods_banner_clients`
--

CREATE TABLE `yegods_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `yegods_banner_tracks`
--

CREATE TABLE `yegods_banner_tracks` (
...
--
-- Table structure for table `yegods_categories`
--

CREATE TABLE `yegods_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `yegods_categories`
--

INSERT INTO `yegods_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 222, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 222, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 222, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 222, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 222, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 222, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `yegods_contact_details`
--

CREATE TABLE `yegods_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `yegods_content`
--

CREATE TABLE `yegods_content` (
...
--
-- Table structure for table `yegods_contentitem_tag_map`
--

CREATE TABLE `yegods_contentitem_tag_map` (
...
--
-- Table structure for table `yegods_content_frontpage`
--

CREATE TABLE `yegods_content_frontpage` (
...
--
-- Table structure for table `yegods_content_rating`
--

CREATE TABLE `yegods_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `yegods_content_types`
--

CREATE TABLE `yegods_content_types` (
...
--
-- Dumping data for table `yegods_content_types`
--

INSERT INTO `yegods_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `yegods_core_log_searches`
--

CREATE TABLE `yegods_core_log_searches` (
...
--
-- Table structure for table `yegods_extensions`
--

CREATE TABLE `yegods_extensions` (
...
--
-- Dumping data for table `yegods_extensions`
--

INSERT INTO `yegods_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `yegods_finder_filters`
--

CREATE TABLE `yegods_finder_filters` (
...
--
-- Table structure for table `yegods_finder_links`
--

CREATE TABLE `yegods_finder_links` (
...
--
-- Table structure for table `yegods_finder_links_terms0`
--

CREATE TABLE `yegods_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_finder_links_terms1`
--

CREATE TABLE `yegods_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms2`
--

CREATE TABLE `yegods_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms3`
--

CREATE TABLE `yegods_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms4`
--

CREATE TABLE `yegods_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms5`
--

CREATE TABLE `yegods_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms6`
--

CREATE TABLE `yegods_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms7`
--

CREATE TABLE `yegods_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms8`
--

CREATE TABLE `yegods_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_terms9`
--

CREATE TABLE `yegods_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_termsa`
--

CREATE TABLE `yegods_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_termsb`
--

CREATE TABLE `yegods_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_termsc`
--

CREATE TABLE `yegods_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_termsd`
--

CREATE TABLE `yegods_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_termse`
--

CREATE TABLE `yegods_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_links_termsf`
--

CREATE TABLE `yegods_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `yegods_finder_taxonomy`
--

CREATE TABLE `yegods_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `yegods_finder_taxonomy`
--

INSERT INTO `yegods_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `yegods_finder_taxonomy_map`
--

CREATE TABLE `yegods_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_finder_terms`
--

CREATE TABLE `yegods_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_finder_terms_common`
--

CREATE TABLE `yegods_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `yegods_finder_terms_common`
--

INSERT INTO `yegods_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `yegods_finder_tokens`
--

CREATE TABLE `yegods_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `yegods_finder_tokens_aggregate`
--

CREATE TABLE `yegods_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_finder_types`
--

CREATE TABLE `yegods_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_languages`
--

CREATE TABLE `yegods_languages` (
...
--
-- Dumping data for table `yegods_languages`
--

INSERT INTO `yegods_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `yegods_menu`
--

CREATE TABLE `yegods_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `yegods_menu`
--

INSERT INTO `yegods_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `yegods_menu_types`
--

CREATE TABLE `yegods_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `yegods_menu_types`
--

INSERT INTO `yegods_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `yegods_messages`
--

CREATE TABLE `yegods_messages` (
...
--
-- Table structure for table `yegods_messages_cfg`
--

CREATE TABLE `yegods_messages_cfg` (
...
--
-- Table structure for table `yegods_modules`
--

CREATE TABLE `yegods_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `yegods_modules`
--

INSERT INTO `yegods_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `yegods_modules_menu`
--

CREATE TABLE `yegods_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `yegods_modules_menu`
--

INSERT INTO `yegods_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `yegods_newsfeeds`
--

CREATE TABLE `yegods_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_overrider`
--

CREATE TABLE `yegods_overrider` (
...
--
-- Table structure for table `yegods_postinstall_messages`
--

CREATE TABLE `yegods_postinstall_messages` (
...
--
-- Dumping data for table `yegods_postinstall_messages`
--

INSERT INTO `yegods_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `yegods_redirect_links`
--

CREATE TABLE `yegods_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_schemas`
--

CREATE TABLE `yegods_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `yegods_schemas`
--

INSERT INTO `yegods_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.0-2016-06-05');

-- --------------------------------------------------------

--
-- Table structure for table `yegods_session`
--

CREATE TABLE `yegods_session` (
...
--
-- Table structure for table `yegods_tags`
--

CREATE TABLE `yegods_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `yegods_tags`
--

INSERT INTO `yegods_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 222, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `yegods_template_styles`
--

CREATE TABLE `yegods_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `yegods_template_styles`
--

INSERT INTO `yegods_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `yegods_ucm_base`
--

CREATE TABLE `yegods_ucm_base` (
...
--
-- Table structure for table `yegods_ucm_content`
--

CREATE TABLE `yegods_ucm_content` (
...
--
-- Table structure for table `yegods_ucm_history`
--

CREATE TABLE `yegods_ucm_history` (
...
--
-- Table structure for table `yegods_updates`
--

CREATE TABLE `yegods_updates` (
...
--
-- Table structure for table `yegods_update_sites`
--

CREATE TABLE `yegods_update_sites` (
...
--
-- Dumping data for table `yegods_update_sites`
--

INSERT INTO `yegods_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
...
--
-- Table structure for table `yegods_update_sites_extensions`
--

CREATE TABLE `yegods_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `yegods_update_sites_extensions`
--

INSERT INTO `yegods_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Table structure for table `yegods_usergroups`
--

CREATE TABLE `yegods_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `yegods_usergroups`
--

INSERT INTO `yegods_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `yegods_users`
--

CREATE TABLE `yegods_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `yegods_users`
--

INSERT INTO `yegods_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(222, 'Super User', 'yegods', 'info@yegods.it', '$2y$10$q/TbuZJ9Oq.2rQHcodj.YuCKS8yDqkz50pMBUDYWgVYfv48hpABM2', 0, 1, '2016-08-27 10:45:16', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `yegods_user_keys`
--

CREATE TABLE `yegods_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `yegods_user_notes`
--

CREATE TABLE `yegods_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `yegods_user_profiles`
--

CREATE TABLE `yegods_user_profiles` (
...
--
-- Table structure for table `yegods_user_usergroup_map`
--

CREATE TABLE `yegods_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `yegods_user_usergroup_map`
--

INSERT INTO `yegods_user_usergroup_map` (`user_id`, `group_id`) VALUES
(222, 8);

-- --------------------------------------------------------

--
-- Table structure for table `yegods_utf8_conversion`
--

CREATE TABLE `yegods_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `yegods_utf8_conversion`
--

INSERT INTO `yegods_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `yegods_viewlevels`
--

CREATE TABLE `yegods_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `yegods_viewlevels`
--

INSERT INTO `yegods_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `yegods_assets`
--
ALTER TABLE `yegods_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_associations`
--
ALTER TABLE `yegods_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `yegods_banners`
--
ALTER TABLE `yegods_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_banner_clients`
--
ALTER TABLE `yegods_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `yegods_banner_tracks`
--
ALTER TABLE `yegods_banner_tracks`
...
--
-- Indexes for table `yegods_categories`
--
ALTER TABLE `yegods_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_contact_details`
--
ALTER TABLE `yegods_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `yegods_content`
--
ALTER TABLE `yegods_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `yegods_contentitem_tag_map`
--
ALTER TABLE `yegods_contentitem_tag_map`
...
--
-- Indexes for table `yegods_content_frontpage`
--
ALTER TABLE `yegods_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `yegods_content_rating`
--
ALTER TABLE `yegods_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `yegods_content_types`
--
ALTER TABLE `yegods_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `yegods_extensions`
--
ALTER TABLE `yegods_extensions`
...
--
-- Indexes for table `yegods_finder_filters`
--
ALTER TABLE `yegods_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `yegods_finder_links`
--
ALTER TABLE `yegods_finder_links`
...
--
-- Indexes for table `yegods_finder_links_terms0`
--
ALTER TABLE `yegods_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms1`
--
ALTER TABLE `yegods_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms2`
--
ALTER TABLE `yegods_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms3`
--
ALTER TABLE `yegods_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms4`
--
ALTER TABLE `yegods_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms5`
--
ALTER TABLE `yegods_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms6`
--
ALTER TABLE `yegods_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms7`
--
ALTER TABLE `yegods_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms8`
--
ALTER TABLE `yegods_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_terms9`
--
ALTER TABLE `yegods_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_termsa`
--
ALTER TABLE `yegods_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_termsb`
--
ALTER TABLE `yegods_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_termsc`
--
ALTER TABLE `yegods_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_termsd`
--
ALTER TABLE `yegods_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_termse`
--
ALTER TABLE `yegods_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_links_termsf`
--
ALTER TABLE `yegods_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `yegods_finder_taxonomy`
--
ALTER TABLE `yegods_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_finder_taxonomy_map`
--
ALTER TABLE `yegods_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `yegods_finder_terms`
--
ALTER TABLE `yegods_finder_terms`
...
--
-- Indexes for table `yegods_finder_terms_common`
--
ALTER TABLE `yegods_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `yegods_finder_tokens`
--
ALTER TABLE `yegods_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `yegods_finder_tokens_aggregate`
--
ALTER TABLE `yegods_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `yegods_finder_types`
--
ALTER TABLE `yegods_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `yegods_languages`
--
ALTER TABLE `yegods_languages`
...
--
-- Indexes for table `yegods_menu`
--
ALTER TABLE `yegods_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_menu_types`
--
ALTER TABLE `yegods_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `yegods_messages`
--
ALTER TABLE `yegods_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `yegods_messages_cfg`
--
ALTER TABLE `yegods_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `yegods_modules`
--
ALTER TABLE `yegods_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_modules_menu`
--
ALTER TABLE `yegods_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `yegods_newsfeeds`
--
ALTER TABLE `yegods_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `yegods_overrider`
--
ALTER TABLE `yegods_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yegods_postinstall_messages`
--
ALTER TABLE `yegods_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `yegods_redirect_links`
--
ALTER TABLE `yegods_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `yegods_schemas`
--
ALTER TABLE `yegods_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `yegods_session`
--
ALTER TABLE `yegods_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `yegods_tags`
--
ALTER TABLE `yegods_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_template_styles`
--
ALTER TABLE `yegods_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `yegods_ucm_base`
--
ALTER TABLE `yegods_ucm_base`
...
--
-- Indexes for table `yegods_ucm_content`
--
ALTER TABLE `yegods_ucm_content`
...
--
-- Indexes for table `yegods_ucm_history`
--
ALTER TABLE `yegods_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `yegods_updates`
--
ALTER TABLE `yegods_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `yegods_update_sites`
--
ALTER TABLE `yegods_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `yegods_update_sites_extensions`
--
ALTER TABLE `yegods_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `yegods_usergroups`
--
ALTER TABLE `yegods_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_users`
--
ALTER TABLE `yegods_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_user_keys`
--
ALTER TABLE `yegods_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `yegods_user_notes`
--
ALTER TABLE `yegods_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `yegods_user_profiles`
--
ALTER TABLE `yegods_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `yegods_user_usergroup_map`
--
ALTER TABLE `yegods_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `yegods_viewlevels`
--
ALTER TABLE `yegods_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `yegods_assets`
--
ALTER TABLE `yegods_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT for table `yegods_banners`
--
ALTER TABLE `yegods_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_banner_clients`
--
ALTER TABLE `yegods_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_categories`
--
ALTER TABLE `yegods_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `yegods_contact_details`
--
ALTER TABLE `yegods_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_content`
--
ALTER TABLE `yegods_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_content_types`
--
ALTER TABLE `yegods_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `yegods_extensions`
--
ALTER TABLE `yegods_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `yegods_finder_filters`
--
ALTER TABLE `yegods_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_finder_links`
--
ALTER TABLE `yegods_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_finder_taxonomy`
--
ALTER TABLE `yegods_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `yegods_finder_terms`
--
ALTER TABLE `yegods_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_finder_types`
--
ALTER TABLE `yegods_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_languages`
--
ALTER TABLE `yegods_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `yegods_menu`
--
ALTER TABLE `yegods_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT for table `yegods_menu_types`
--
ALTER TABLE `yegods_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `yegods_messages`
--
ALTER TABLE `yegods_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_modules`
--
ALTER TABLE `yegods_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `yegods_newsfeeds`
--
ALTER TABLE `yegods_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_overrider`
--
ALTER TABLE `yegods_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `yegods_postinstall_messages`
--
ALTER TABLE `yegods_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `yegods_redirect_links`
--
ALTER TABLE `yegods_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_tags`
--
ALTER TABLE `yegods_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `yegods_template_styles`
--
ALTER TABLE `yegods_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `yegods_ucm_content`
--
ALTER TABLE `yegods_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_ucm_history`
--
ALTER TABLE `yegods_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_updates`
--
ALTER TABLE `yegods_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_update_sites`
--
ALTER TABLE `yegods_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `yegods_usergroups`
--
ALTER TABLE `yegods_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `yegods_users`
--
ALTER TABLE `yegods_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
--
-- AUTO_INCREMENT for table `yegods_user_keys`
--
ALTER TABLE `yegods_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_user_notes`
--
ALTER TABLE `yegods_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `yegods_viewlevels`
--
ALTER TABLE `yegods_viewlevels`
